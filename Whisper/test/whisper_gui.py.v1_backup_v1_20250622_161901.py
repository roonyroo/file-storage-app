...
class WhisperGUI:
    ...
    def paste_text(self):
        if self.transcription:
            ...
            self.root.after(2000, self.perform_paste)
...
def main():
    try:
        ...
        # Try to restart the application if it crashes
        if messagebox.askyesno("Restart Application", "Would you like to restart the application?"):
            logger.info("Restarting application after crash")
